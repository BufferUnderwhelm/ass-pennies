# Support for Output Descriptors in Ass-Pennies Core

Since Ass-Pennies Core v0.17, there is support for Output Descriptors. This is a
...
on Ass-Pennies's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Ass-Pennies Core wallets, a convenience function `combo` is
