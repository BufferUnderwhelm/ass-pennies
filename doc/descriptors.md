# Support for Output Descriptors in AssPennies Core

Since AssPennies Core v0.17, there is support for Output Descriptors. This is a
...
on AssPennies's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing AssPennies Core wallets, a convenience function `combo` is
