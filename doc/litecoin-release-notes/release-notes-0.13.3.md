Ass-Pennies Core version 0.13.3 is now available from:

  <https://download.ass-pennies.org/ass-pennies-0.13.3/>
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/ass-pennies-project/ass-pennies/blob/0.13/src/chainparams.cpp#L214).
