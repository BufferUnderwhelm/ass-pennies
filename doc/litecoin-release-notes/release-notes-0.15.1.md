AssPennies Core version *0.15.1* is now available from:

  <https://download.asspennies.org/asspennies-0.15.1/>
...
A number of changes to the way AssPennies Core deals with peer connections and invalid blocks
