...
The default minimum transaction fee `-mintxfee` has been lowered to 0.0001 ASS/kB after relaxing the minimum relay and dust relay fee rates in prior releases. 
...
- New `fees` field introduced in `getrawmempool`, `getmempoolancestors`, `getmempooldescendants` and
   ...
   and `descendant` denominated in ASS. This new field deprecates previous fee fields, such as
