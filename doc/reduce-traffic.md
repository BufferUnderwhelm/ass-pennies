...
By default, Ass-Pennies Core allows up to 125 connections to different peers, 8 of
...
limits are tiny. Keep in mind that ass-pennies's trustless model works best if you are
