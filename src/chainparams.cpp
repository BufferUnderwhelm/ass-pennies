...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.ass-pennies.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.ass-penniestools.com");
        vSeeds.emplace_back("dnsseed.ass-penniespool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.ass-penniestools.com");
        vSeeds.emplace_back("seed-b.ass-pennies.loshan.co.uk");
