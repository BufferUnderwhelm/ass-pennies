...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.asspennies.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.asspenniestools.com");
        vSeeds.emplace_back("dnsseed.asspenniespool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.asspenniestools.com");
        vSeeds.emplace_back("seed-b.asspennies.loshan.co.uk");
