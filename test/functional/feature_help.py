...
"""Verify that starting asspennies with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start asspennies with -h for help text")
        ...
        self.log.info("Start asspennies with -version for version information")
        ...
        self.log.info("Start asspenniesd with -fakearg to make sure it does not start")
