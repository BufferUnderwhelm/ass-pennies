...
"""Verify that starting ass-pennies with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ass-pennies with -h for help text")
        ...
        self.log.info("Start ass-pennies with -version for version information")
        ...
        self.log.info("Start ass-penniesd with -fakearg to make sure it does not start")
